...
case "$1" in
build)
   cmake .. -DCMAKE_BUILD_TYPE:STRING=$BUILD_TYPE -DOPTION_BUILD_TRANSLATIONS=$BUILD_TRANSLATIONS -DOPTION_BUILD_WEBSITE_TOOLS=$BUILD_WEBSITE_TOOLS -DOPTION_ASAN="OFF" -DOPTION_UBSAN="OFF" -DOPTION_BUILD_CODECHECK="OFF"
   # Do the actual build.
   make -k -j3
